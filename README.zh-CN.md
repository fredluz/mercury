...
Mercury 是 [Hermes Desktop](https://github.com/fathah/hermes-desktop) 的公开 fork 和改造版本，并围绕 [Hermes Agent](https://github.com/NousResearch/hermes-agent) 构建。这个 fork 保留上游 MIT 许可证和署名，同时加入 Mercury 自己的追踪检查、技能演化、运行评估和桌面产品体验改进。

我们会在适合 Mercury 方向的地方继续吸收上游更新。

## 安装

请从 [Mercury Releases](https://github.com/fredluz/mercury/releases/) 页面下载最新构建版本。
...
欢迎贡献！请查看 [贡献指南](CONTRIBUTING.zh-CN.md) 开始参与。如果你不知道从哪里入手，可以先看看 [open issues](https://github.com/fredluz/mercury/issues)。如果你发现 bug 或希望提出功能请求，也欢迎 [提交 issue](https://github.com/fredluz/mercury/issues/new)。
