# Mercury Trace, Evaluation, and Skill Training Spec

Date: 2026-05-12

## Product Direction

This private mirror adapts Mercury from a terminal replacement plus chat UI into the primary macOS app for operating Hermes. Chat remains central, but every Hermes run should also become inspectable, reviewable, and improvable.
...
The current implementation records the events Mercury already sees through chat IPC and streaming callbacks. Later Hermes Agent should emit canonical structured trace events directly.
