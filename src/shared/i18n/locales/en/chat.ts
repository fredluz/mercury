export default {
  ...
  runtimeReadinessReasonFallback: "API runtime identity has not been verified yet.",
  ...
  runtimeStillUnverified: "API runtime is still not verified. Try debugging with an agent.",
