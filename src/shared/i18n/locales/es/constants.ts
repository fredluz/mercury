export default {
  ...
  codexAppServerName: "Servidor de app Codex",
  codexAppServerDesc: "Runtime de OpenAI Codex con OAuth",
  codexAppServerTag: "Recomendado",
  ...
  opencodeGoDesc: "Suscripción de modelos abiertos",
  localName: "Local",
