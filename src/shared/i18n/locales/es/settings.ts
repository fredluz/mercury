export default {
  ...
  latestApprovedVersion: "Última versión aprobada instalada",
  breakingChange: "Cambio incompatible",
  readFullNotes: "Leer notas completas",
  ...
  remoteUrlHint: "La URL del servidor de API de Hermes (debe exponer /health, /v1/capabilities, /api/sessions y /v1/runs)",
  ...
  modelsEntryDescription:
    "Configura valores de modelo por rol y administra la biblioteca de modelos guardados.",
  openModels: "Abrir configuración de Modelos",
} as const;
