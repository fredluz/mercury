export default {
  ...
  contextTooltip:
    "{{used}} de {{limit}} tokens usados na janela de contexto de {{model}}.",
  contextTooltipEstimated:
    "Estimado: {{used}} de {{limit}} tokens usados na janela de contexto de {{model}}.",
  ...
  runtimeInputDisabled:
    "Aguardando o runtime de API verificado antes de iniciar o chat.",
  quickAskTitle:
  ...
  noModelsAvailable: "Nenhum modelo conectado",
  noModelsAvailableHint:
    "Conecte um provedor em Provedores antes de escolher um modelo de chat.",
