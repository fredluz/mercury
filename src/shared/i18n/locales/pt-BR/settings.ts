export default {
  ...
  latestApprovedVersion: "Versão aprovada mais recente instalada",
  breakingChange: "Mudança incompatível",
  readFullNotes: "Ler notas completas",
  ...
  remoteUrlHint: "A URL do servidor da API do Hermes (deve expor /health, /v1/capabilities, /api/sessions e /v1/runs)",
  ...
  modelsEntryTitle: "Modelos",
  modelsEntryDescription:
    "Configure padrões de modelo por função e gerencie a biblioteca de modelos salvos.",
  openModels: "Abrir configurações de Modelos",
} as const;
