export default {
  ...
  latestApprovedVersion: "已安装最新已批准版本",
  breakingChange: "破坏性变更",
  readFullNotes: "查看完整说明",
  ...
  remoteUrl: "远程服务器地址",
  remoteUrlHint: "Hermes API 服务器地址（需开放 /health、/v1/capabilities、/api/sessions 和 /v1/runs）",
  remoteApiKey: "API 密钥",
  ...
  modelsEntryTitle: "模型",
  modelsEntryDescription: "配置基于角色的模型默认值，并管理已保存模型库。",
  openModels: "打开模型设置",
} as const;
